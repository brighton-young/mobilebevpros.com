var ccfwooController = {
    ...
    setIsCounting(o) {
        !1 === o ? ccfwooController.classes("remove", "checkout-countdown-is-counting") : (ccfwooController.classes("add", "checkout-countdown-is-counting"), ccfwooController.classes("remove", "ccfwoo-is-hidden")), this.counting = o
    },
    stopInterval(o) {
    ...
    triggerEvent(o, e) {
        if (e = new Event(e, {
                bubbles: !0
            }), "document" === o && document.dispatchEvent(e), "window" === o && window.dispatchEvent(e), "body" === o) {
...
function ccfwooCounter() {
    ...
    !0 === e.isPast ? (ccfwooController.setHtml("loading"), ccfwooController.stopInterval(!0), ccfwooController.triggerEvent("document", "ccfwooReachedZero", !0), setTimeout((function() {
    ...
    }), 1e3 * parseInt(ccfwooLocal.expired_message_seconds))) : ccfwooController.setHtml("counting", !1, e)
}
...
document.addEventListener("DOMContentLoaded", (function(o) {
    ...
    const e = ccfwooGetCookie("woocommerce_items_in_cart"),
        t = e && e >= 1 ? 1 : 0;
    ccfwooController.setCartItems(t), ccfwooCounter(), ccfwooController.startInterval(), ccfwooController.isCounting() && ccfwooController.classes("add", "checkout-countdown-is-counting")
